import { appendFileSync, readFileSync, mkdirSync, existsSync, openSync, writeSync, closeSync, unlinkSync, statSync, } from 'node:fs';
 ...
 */
export function acquireLogLock(projectRoot) {
...
function recountEntries(filePath) {
    try {
 ...
 */
export function readDecisionLogDetailed(projectRoot) {
