"""Tests for :mod:`iterate_harness.utils.fs` atomic-write helpers."""
...
from iterate_harness.utils.fs import atomic_write_bytes, atomic_write_text
...
def test_existing_file_is_untouched_on_write_failure(
    ...
    monkeypatch.setattr("iterate_harness.utils.fs.os.replace", _boom)
