...
class TestRequestDeviceCode:
    ...
    def test_request_device_code_happy_path(self, monkeypatch):
        ...
        monkeypatch.setattr("iterate_harness.api.copilot_auth.httpx.post", fake_post)
...
class TestPollForAccessToken:
    ...
    def test_returns_token_after_pending(self, monkeypatch):
        ...
        monkeypatch.setattr("iterate_harness.api.copilot_auth.httpx.post", fake_post)
        monkeypatch.setattr("iterate_harness.api.copilot_auth.time.sleep", lambda _: None)
    ...
    def test_slow_down_increases_interval(self, monkeypatch):
        ...
        monkeypatch.setattr("iterate_harness.api.copilot_auth.httpx.post", fake_post)
        monkeypatch.setattr("iterate_harness.api.copilot_auth.time.sleep", fake_sleep)
    ...
    def test_timeout_raises_runtime_error(self, monkeypatch):
        ...
        monkeypatch.setattr("iterate_harness.api.copilot_auth.httpx.post", fake_post)
        monkeypatch.setattr("iterate_harness.api.copilot_auth.time.sleep", lambda _: None)
        monkeypatch.setattr("iterate_harness.api.copilot_auth.time.monotonic", fake_monotonic)
