"""Real large tasks that exercise multiple IterateHarness features together.
...
async def task_migration_plan_with_memory():
    ...
    from iterate_harness.services.session_storage import save_session_snapshot, export_session_markdown
