"""Unified authentication manager for IterateHarness providers."""
...
class AuthManager:
    ...
    Reads/writes credentials via :mod:`iterate_harness.auth.storage` and keeps
    ...
    def save_settings(self) -> None:
        ...
        from iterate_harness.config import save_settings
