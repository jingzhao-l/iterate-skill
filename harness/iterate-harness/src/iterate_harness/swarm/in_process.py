...
async def start_in_process_teammate(
    *,
    ...
    2. Drives the query engine loop (reusing
       :func:`~iterate_harness.engine.query.run_query`).
...
async def _run_query_loop(
    ...
    """Drive :func:`~iterate_harness.engine.query.run_query` until done or cancelled.
    ...
    from iterate_harness.engine.query import run_query
