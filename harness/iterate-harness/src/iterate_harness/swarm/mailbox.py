"""File-based async message queue for leader-worker communication in IterateHarness swarms.

Each message is stored as an individual JSON file:
    ~/.iterate-harness/teams/<team>/agents/<agent_id>/inbox/<timestamp>_<message_id>.json
