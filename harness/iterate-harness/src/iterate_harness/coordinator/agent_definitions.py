"""Agent definition loading system for IterateHarness."""
...
def get_all_agent_definitions() -> list[AgentDefinition]:
    ...
    1. Built-in agents
    2. User agents (~/.iterate-harness/agents/)
    ...
    try:
        from iterate_harness.plugins.loader import load_plugins  # noqa: PLC0415
        from iterate_harness.config.settings import load_settings  # noqa: PLC0415
