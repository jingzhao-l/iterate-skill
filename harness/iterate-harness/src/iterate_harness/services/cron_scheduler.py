...
Runs as a standalone process (``ih cron start``) or can be embedded via
...
from iterate_harness.config.paths import get_data_dir, get_logs_dir
...
# ---------------------------------------------------------------------------
# Daemon entry point (spawned by ``ih cron start``)
# ---------------------------------------------------------------------------
