...
from iterate_harness.services import session_storage
...
class IterateHarnessSessionBackend:
    """Default session backend backed by ``~/.iterate-harness/data/sessions``."""
...
DEFAULT_SESSION_BACKEND: SessionBackend = IterateHarnessSessionBackend()
