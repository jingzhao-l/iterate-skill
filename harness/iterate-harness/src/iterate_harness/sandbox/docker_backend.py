...
from iterate_harness.config import Settings
from iterate_harness.platforms import get_platform, get_platform_capabilities
from iterate_harness.sandbox.adapter import SandboxAvailability, SandboxUnavailableError
...
class DockerSandboxSession:
    """Manages a long-running Docker container for one IterateHarness session."""
    ...
    def __post_init__(self) -> None:
        self._container_name = f"iterate_harness-sandbox-{self.session_id}"
    ...
    async def start(self) -> None:
        ...
        from iterate_harness.sandbox.docker_image import ensure_image_available
