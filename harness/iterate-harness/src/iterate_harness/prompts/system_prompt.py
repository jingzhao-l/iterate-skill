"""System prompt builder for IterateHarness.
...
from iterate_harness.prompts.environment import EnvironmentInfo, get_environment_info


_BASE_SYSTEM_PROMPT = """\
You are IterateHarness, an open-source AI coding assistant CLI. \
