...
IterateHarness settings system evolves independently.
"""
...
class FeishuConfig(BaseChannelConfig):
    ...
    # Group reply policy is enforced by the gateway because managed-group
    # metadata lives outside the generic Feishu channel adapter.
    group_policy: str = "managed_or_mention"
    bot_open_id: str = ""
    bot_names: list[str] = Field(default_factory=lambda: ["iterate_harness"])
