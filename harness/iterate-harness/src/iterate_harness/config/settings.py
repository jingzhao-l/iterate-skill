"""Settings model and loading logic for IterateHarness.
...
class DockerSandboxSettings(BaseModel):
    ...
    image: str = "iterate_harness-sandbox:latest"
...
class Settings(BaseModel):
    """Main settings model for IterateHarness."""
...
def load_settings(config_path: Path | None = None) -> Settings:
    ...
    if config_path is None:
        from iterate_harness.config.paths import get_config_file_path
