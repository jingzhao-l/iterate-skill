...
from iterate_harness.ui.backend_host import run_backend_host
from iterate_harness.ui.coordinator_drain import drain_coordinator_async_agents
from iterate_harness.ui.react_launcher import launch_react_tui
...
async def run_task_worker(
    *,
    ...
    async def _render_event(event: StreamEvent) -> None:
        from iterate_harness.engine.stream_events import AssistantTextDelta, AssistantTurnComplete, ErrorEvent, StatusEvent
