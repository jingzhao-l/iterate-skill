...
from iterate_harness.commands import MemoryCommandBackend
from iterate_harness.config.settings import CLAUDE_MODEL_ALIAS_OPTIONS, resolve_model_setting
...
from iterate_harness.themes import list_themes
...
class ReactBackendHost:
    """Drive the IterateHarness runtime over a structured stdin/stdout protocol."""
