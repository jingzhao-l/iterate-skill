"""Default Textual terminal UI for IterateHarness."""
...
class IterateHarnessTerminalApp(App[None]):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Horizontal(id="main-row"):
            with Vertical(id="transcript-column"):
                ...
                yield Input(placeholder="Ask IterateHarness or enter a /command", id="composer")
